...
The home page has a navbar component ([/arwa-webshop/src/components/README.md]) , when the user hover on it a dropdown menu will appear depending on which item in the navbar the user hovered on.
</br>
</br>
