...
Arwa-webshop is an e-commerce web application built using React([/arwa-webshop/src](https://reactjs.org/)). For styling styled-components was used (https://styled-components.com/).
